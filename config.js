  ...
  programs: [
    {
      ...
      priceLabel: '49\u20AC',
      duration: '30 minutes',
      shortDesc: 'Une expertise immediate sur ta problematique beaute, vitalite ou gestion du poids.',
      ...
      features: [
        ...
        'Conseils alimentaires, routine beaute, skincare',
        'Orientation complementaire ou complements alimentaires si necessaire'
      ],
      stripeLink: '',
      hasEspace: false,
      comingSoon: false
    },
    {
      ...
      priceLabel: '247\u20AC',
      duration: '21 jours',
      paymentNote: 'Paiement en plusieurs fois possible',
      ...
      features: [
        ...
        'Recettes basiques',
        'Ebook',
        '2 coachings individuels d\'1h (ouverture + cloture)',
        'Recommandations de paniers bien-etre',
        'Comptes-rendus des coachings',
        'Acces espace client 21 jours'
      ],
      upsell: { title: 'Option Tracker', price: 47, priceLabel: '+47\u20AC', desc: 'Ajoute le tracker bien-etre quotidien a ton programme' },
      stripeLink: '',
      hasEspace: true,
      comingSoon: false
    },
    {
      ...
      features: [
        ...
        '5 coachings individuels d\'1h',
        'WhatsApp avec moi 5/7 : correction repas en direct, reponses sur tes courses, motivation',
        'Recommandations de paniers bien-etre',
        'Comptes-rendus des coachings',
    ...
    },
    {
      ...
      priceLabel: 'Bientot',
      duration: '6 mois',
      shortDesc: 'Le programme signature de Sois Sublime. 6 mois pour te transformer en profondeur.',
      description: '',
      features: [],
      stripeLink: '',
      hasEspace: true,
